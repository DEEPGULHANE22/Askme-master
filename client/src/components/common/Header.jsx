...
<div className="d-flex align-items-center justify-content-between">
  <a href="index.html" className="logo d-flex align-items-center">
    ...
    <span className="d-none d-lg-block">Quora</span>
  </a>
  <div onClick={sidebar} >
...
<div className="search-bar">
  <form className="search-form d-flex align-items-center" method="POST" action="#ok">
...
<nav className="header-nav ms-auto">
  <ul className="d-flex align-items-center">
    ...
    <li className="nav-item dropdown">
      ...
      <a className="nav-link nav-icon" href="#ok" data-bs-toggle="dropdown">
      ...
      <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
        <li className="dropdown-header">
          ...
          <a href="#ok"><span className="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
        </li>
        <li>
    ...
    <li className="nav-item dropdown pe-3">
      ...
      <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#ok" data-bs-toggle="dropdown">
      ...
      <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a className="dropdown-item d-flex align-items-center" href="#ok">
  ...
  <aside id="sidebar" className="sidebar" >
    ...
    <ul className="sidebar-nav" id="sidebar-nav">
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#okcomponents-nav" data-bs-toggle="collapse" href="#ok">
          <i className="bi bi-menu-button-wide"></i><span>Components</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" className="nav-content collapse " data-bs-parent="#oksidebar-nav">
          <li>
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#okforms-nav" data-bs-toggle="collapse" href="#ok">
          <i className="bi bi-journal-text"></i><span>Forms</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#oksidebar-nav">
          <li>
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#oktables-nav" data-bs-toggle="collapse" href="#ok">
          <i className="bi bi-layout-text-window-reverse"></i><span>Tables</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" className="nav-content collapse " data-bs-parent="#oksidebar-nav">
          <li>
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#okcharts-nav" data-bs-toggle="collapse" href="#ok">
          <i className="bi bi-bar-chart"></i><span>Charts</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" className="nav-content collapse " data-bs-parent="#oksidebar-nav">
          <li>
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#okicons-nav" data-bs-toggle="collapse" href="#ok">
          <i className="bi bi-gem"></i><span>Icons</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" className="nav-content collapse " data-bs-parent="#oksidebar-nav">
          <li>
